document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderMessage(msg, currentUserId, previousMsg) {
        ...
        if (msg.type === 'image' && msg.imageUrl) {
            messageContent = `<img src="${msg.imageUrl}" alt="Image message" class="chat-image" loading="lazy">`;
        } else {
            ...
            if (otherUserProfile) {
                if(menuAvatar) {
                    ...
                    if(avatarContent.startsWith('http')) {
                        menuAvatar.innerHTML = `<img src="${avatarContent}" alt="${otherUserProfile.username}" loading="lazy" />`;
                    } else {
